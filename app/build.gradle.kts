...
android {
    namespace = "su.vi.androidsynergypractice"
    compileSdk = 36

    defaultConfig {
        applicationId = "su.vi.androidsynergypractice"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
    ...
    composeOptions {
        kotlinCompilerExtensionVersion = "1.5.15" // Ensure this matches the compatibility map
    }
}
...
dependencies {
    ...
    implementation(project(":CalcFeatureImpl"))
